...
module.exports = {
  ...
  networks: {
    ...
    polygon: {
      url: `https://polygon.infura.io/v3/${process.env.POLYGON_INFURA_KEY}`,
      gasPrice: 3200000000,
      accounts: [process.env.POLYGON_DEPLOYER_PRIV_KEY],
    },
    mumbai: {
      url: `https://mumbai.infura.io/v3/${process.env.MUMBAI_INFURA_KEY}`,
      gasPrice: 3200000000,
    ...
    matic: {
      ...
      gasPrice: 1000000000,
      accounts: [process.env.MATIC_DEPLOYER_PRIV_KEY],
    },
    optimism: {
      url: "https://mainnet.optimism.io",
      accounts: [process.env.OPTIMISM_PRIV_KEY],
      companionNetworks: {
        l1: "mainnet",
      },
    },
